...
\begin{defbox}[Main Roles \& Functionalities]
    \begin{itemize}
...
\begin{defbox}[What has to be developed?]
    \begin{itemize}
...
\begin{defbox}[What is Requirements Engineering?]
    The process of 
    \begin{itemize}
        \item finding
        \item analysing
...
\begin{defbox}[Examples of Non-Functional Requirements]
    \begin{itemize}
...
\begin{defbox}[Systematic Requirement Discovery\newline Viewpoint-Oriented Approach]
    \begin{itemize}
...
\begin{defbox}[SRS Target Groups]
    \begin{itemize}
        \item Client, users
...
\begin{defbox}[System Requirement Specification (SRS) Document Format]
    \begin{enumerate}
        \item Introduction
        \begin{enumerate}
