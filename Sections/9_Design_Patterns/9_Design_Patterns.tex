...
\begin{minipage}
    [t]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Pics/DesignPatternUMLClassDiagram.png}
\end{minipage}
\hfill
\begin{minipage}
    [t]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Pics/DesignPatternUMLClassDiagram1.png}
\end{minipage}
...
\begin{minipage}
    [t]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Pics/FactoryMethod.png}
\end{minipage}
\hfill
\begin{minipage}
    [t]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Pics/FactoryMethodExample.png}
\end{minipage}
...
\begin{figure}
    [htp]
    \centering
    \includegraphics[width = 0.5\textwidth]{Pics/AbstractFactory_DatabaseExample.png}
\end{figure}
...
\begin{minipage}
    [t]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Pics/AbstractFactory.png}
\end{minipage}
\hfill
\begin{minipage}
    [t]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Pics/AbstractFactoryExample.png}
\end{minipage}
