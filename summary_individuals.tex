...
\preauthor{\begin{flushleft}\large \lineskip 0.5em \fontsize{15}{0} \usefont{T1}{phv}{b}{n} \color{Black}} % Author font configuration
	...
	\postauthor{% Anything you might want to add
        \\ \large LaTeX version: \href{https://github.com/moricetamol/Software_Engineering_Summary}{\vcentered{\includegraphics[height=15pt]{Github_logo.png}} \large \texttt{moricetamol}}
