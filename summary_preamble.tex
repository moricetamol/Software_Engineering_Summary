...
\newcommand{\TitleRule}{\color{codered} \rule{\linewidth}{15pt} \vspace{-90pt}\linebreak \HorRule \linebreak}
...
%[] % Shape
{\color{codered} \titlerule[15pt] \color{White} \titlerule[7pt] \color{Black} \titlerule[2pt] \SectionFont} % Format
{\thesection} % Label
{1em} % Seperator
...
\tcbset{
    ...
    codingbox/.style={
        purplebox % Change these to the colors you want your code boxes to be
    }
}
