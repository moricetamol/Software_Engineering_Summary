...
\newtcolorbox[]{greenbox*}[1][]{gb}
\newtcolorbox[]{greenbox}[1][]{
    gb,
    title=\IfValueTF{#1}{#1}{},
}

\newtcolorbox[]{magentabox*}[1][]{magbox}
\newtcolorbox[]{magentabox}[1][]{
    magbox,
    title=\IfValueTF{#1}{#1}{},
}

\newtcolorbox{smallmagbox*}{
    magbox,
    hbox,
}
...
\usepackage[colorlinks, linkcolor=black, urlcolor=magenta]{hyperref} % For hyperlinks, automatically created for table of contents
\usepackage{xr-hyper}
